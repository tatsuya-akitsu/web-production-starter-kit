  ...
  <div>
    <section class="section section-terms">
      <div class="wrapper--terms">
        ...
        <p class="terms__text">
          この利用規約（以下，「本規約」といいます。）は，POiDER（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <h3>第1条(適用)</h3>
        <p class="terms__text">本規約は，ユーザーと当社との間の本サービスの利用に関わる一切の関係に適用されるものとします。</p>
        <h3>第2条(利用登録)</h3>
        <ul>
        ...
        <h3>第5条(禁止事項)</h3>
        <p class="terms__text">ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
        <ul>
        ...
        <ul>
          ...
          <ul>
            ...
            <li>その他，当社が本サービスの利用を適当でないと判断した場</li>
          </ul>
