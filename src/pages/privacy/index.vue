  ...
  <div>
    <section class="section section-terms">
      <div class="wrapper--terms">
        ...
        <p class="terms__text">
          POiDER（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）におけるプライバシー情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        <h3>第1条(プライバシー情報)</h3>
        <ul>
        ...
        <p class="terms__text">当社が個人情報を収集・利用する目的は，以下のとおりです。</p>
        <ul>
        ...
        <ul>
          ...
          <ul>
            ...
            <li>当社の業務の適正な実施に著しい支障を及ぼすおそれがある場合当社の業務の適正な実施に著しい支障を及ぼすおそれがある場合</li>
            <li>その他法令に違反することとなる場合</li>
          </ul>
          <li>前項の定めにかかわらず，履歴情報および特性情報などの個人情報以外の情報については，原則として開示いたしません。</li>
        </ul>
        <h3>第6条(個人情報の訂正・削除)</h3>
        <ul>
        ...
        <p class="terms__text">
          ...
          Email:<a href="mailto:poider.sp1@gmail.com">poider.sp1@gmail.com</a>
        </p>
        <p class="terms-end__text">2018年10月4日 制定</p>
      </div>
    </section>
  </div>
</template>
